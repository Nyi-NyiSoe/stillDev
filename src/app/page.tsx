    ...
    <AppShell>
      <div className="grid flex-1 items-center gap-8 py-10 lg:grid-cols-[minmax(0,1fr)_22rem] lg:py-16">
        <section className="max-w-3xl">
          <p className="mb-4 text-sm font-semibold uppercase text-zinc-600">
            StillDev
          </p>
          <h1 className="max-w-3xl text-4xl font-semibold leading-tight text-zinc-950 sm:text-6xl">
        ...
        <Card className="lg:justify-self-end">
          <div className="space-y-5">
            <div>
              <p className="text-sm font-semibold text-zinc-950">Daily check</p>
              <p className="mt-1 text-sm leading-6 text-zinc-600">
                10 focused questions matched to your profile.
              </p>
            </div>
            <div className="grid grid-cols-3 gap-2 border-y border-zinc-200 py-4 text-center">
